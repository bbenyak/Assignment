...
twoway scatter price beds || lfit price beds, title("Number of beds at airbnb apartment and prices") saving(../Output/airbnb_london_morebeds_highcost.png, replace)
...
esttab 
esttab using ../Output/airbnb_regressions.doc, noabbrev replace
eststo clear
...
graph hbar price, over(neighbourhood_cleansed, label(labsize(vsmall))) ytitle("Average price") title("Average airbnb price by neighbourhood") saving((../Output/airbnb_london_hoods_prices.png, replace)

graph hbar beds, over(neighbourhood_cleansed, label(labsize(vsmall))) ytitle("Average number of beds") title("Average nr of airbnb beds by neighbourhood") saving(../Output/airbnb_london_hoods_beds.png, replace)

graph hbar bedrooms, over(neighbourhood_cleansed, label(labsize(vsmall))) ytitle("Average number of bedrooms") title("Average nr of airbnb bedrooms by neighbourhood") saving(../Output/airbnb_london_hoods_bedrooms.png, replace)

graph hbar pool, over(neighbourhood_cleansed, label(labsize(vsmall))) ytitle("Average number of pools") title("Average nr of airbnb pools by neighbourhood") saving(../Output/airbnb_london_hoods_pools.png, replace)
